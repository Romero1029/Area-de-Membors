...
export function WhatsAppButton() {
  return (
    <a
      ...
      className="hidden md:flex fixed bottom-7 right-7 z-50 w-14 h-14 rounded-full items-center justify-center shadow-xl hover:scale-110 active:scale-95 transition-transform duration-200"
