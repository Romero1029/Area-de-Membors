...
const WA_GROUP_URL   = 'https://chat.whatsapp.com/PENDENTE_GRUPO_VIP_47'
const INTRO_VIDEO_ID = ''
const EBOOK_URL      = '#'
const BANNER_URL     = ''  // ex: '/banner-sdw47.png'
...
const AULAS: Aula[] = [
  {
    ...
    gcal: { titulo: 'SDW #47 — Aula 1', inicio: '20260901T230000Z', fim: '20260902T010000Z', desc: 'Aula 1 da Semana do Despertar #47 · IDM' },
  },
  {
    id: 2,
    ...
    gcal: { titulo: 'SDW #47 — Aula 2', inicio: '20260902T230000Z', fim: '20260903T010000Z', desc: 'Aula 2 da Semana do Despertar #47 · IDM' },
  },
  {
    id: 3,
    ...
    gcal: { titulo: 'SDW #47 — Aula 3', inicio: '20260903T230000Z', fim: '20260904T010000Z', desc: 'Aula 3 da Semana do Despertar #47 · IDM' },
  },
]

const XP_PER_STEP = 200
const TOTAL_STEPS  = 3
const STORAGE_KEY  = 'sdw47_progress'

// 22h Horário de Brasília em 03/09/2026 (última aula) = 01h UTC do dia 04/09/2026
const CERT_UNLOCK = new Date('2026-09-04T01:00:00Z')
...
function openCalendar(aula: Aula) {
  ...
  if (isIOS) {
    const ics = ['BEGIN:VCALENDAR','VERSION:2.0','PRODID:-//IDM//SDW47//PT','BEGIN:VEVENT',
      `SUMMARY:${titulo}`,`DTSTART:${inicio}`,`DTEND:${fim}`,
      `DESCRIPTION:${descFull.replace(/\n/g,'\\n')}`,`URL:${aula.youtubeUrl}`,
      'END:VEVENT','END:VCALENDAR'].join('\r\n')
    const blob = new Blob([ics], { type: 'text/calendar;charset=utf-8' })
    const a = Object.assign(document.createElement('a'), { href: URL.createObjectURL(blob), download: `sdw47-aula${aula.id}.ics` })
    ...
    return (
      <div className="text-center space-y-4 py-2">
        ...
        <div>
          ...
          <p className="text-xs text-white/35 mt-0.5">Parabéns por concluir a Semana do Despertar #47.</p>
        </div>
...
// MAIN COMPONENT
// ─────────────────────────────────────────────
export function SemanaDespertar47({ firstName }: { firstName: string }) {
        ...
        <div className="w-full max-w-2xl mx-auto px-5 sm:px-8 pt-10 pb-24">
          ...
          <div className="mb-10">
            ...
            <div className="flex items-center justify-between border-t border-b border-white/[0.08] py-2.5 mb-7">
              ...
              <span className="text-[10px] uppercase tracking-[0.15em] text-white/25 border border-white/[0.12] px-2 py-0.5 rounded">SDW #47</span>
            </div>
            ...
            <p className="text-sm text-white/60 leading-relaxed mb-7">
              ...
              <span className="text-white/80 font-semibold">01, 02 e 03 de Setembro.</span>
              <br />
                ...
                <StepCard
                  ...
                  subtitle={
                    certUnlocked
                      ...
                      : 'Libera às 22h · 03/09 · após a última aula'
                  }
                >
                  <div className="space-y-4">
                    ...
                    <div className="flex items-start gap-4">
                      ...
                      <div>
                        <p className="text-sm font-semibold text-white/75">Certificado da Semana do Despertar #47</p>
                    ...
                    {!certUnlocked ? (
                      ...
                      <div className="rounded-xl border border-[#FFB800]/12 p-4"
                        ...
                        <p className="text-[11px] text-white/25 leading-relaxed">
                          📅 03/09 às 22h (Horário de Brasília) — ao final da 3ª aula ao vivo
                        </p>
                      </div>
                    ) : todasAulasFeitas ? (
