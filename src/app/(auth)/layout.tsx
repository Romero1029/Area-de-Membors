  ...
  return (
    <div className="min-h-screen grid lg:grid-cols-2">
      ...
      <div
        ...
        style={{ background: 'linear-gradient(160deg, #0f2233 0%, #172432 60%, #1a2430 100%)' }}
      >
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[400px] h-[400px] rounded-full opacity-[0.07]"
          style={{ background: 'radial-gradient(circle, #c79a3b 0%, transparent 70%)' }} />
        ...
        <div className="relative space-y-6">
          ...
          <blockquote className="text-3xl font-bold text-white leading-snug"
            style={{ fontFamily: 'var(--font-fraunces, Georgia, serif)', maxWidth: '380px' }}>
            "Desperte o que já<br />existe dentro de você."
          </blockquote>
          <p className="text-base leading-relaxed" style={{ color: 'rgba(255,255,255,0.5)', maxWidth: '340px' }}>
            ...
            {['Cursos com certificado de conclusão', 'Aulas ao vivo com especialistas', 'Comunidade de apoio e crescimento'].map((item) => (
              <div key={item} className="flex items-center gap-2.5">
                <div className="w-4 h-4 rounded-full flex items-center justify-center shrink-0"
                  style={{ background: 'rgba(199,154,59,0.2)', border: '1px solid rgba(199,154,59,0.35)' }}>
                  <div className="w-1.5 h-1.5 rounded-full" style={{ background: '#c79a3b' }} />
                </div>
